...
from Testing.Data_preparation import *
from Testing.CSV_utilities import *

print('## Reading images ##')
X_test, test_images_names = get_Dataset(image_size=224, isRGB=1)
...
def ResNet50(input_shape=(224, 224, 3)):
    ...
    X = X = convolutional_block(X, f=3, filters=[512, 512, 2048], stage=5, block='a')
...
model.load_weights('../../resnet-best-weights.h5')

print('## Generating CSV for predictions ##')
generateTestingCSV(model, X_test, test_images_names=test_images_names)
print('## Done ##')
